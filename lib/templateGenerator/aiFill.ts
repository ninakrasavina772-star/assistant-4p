    ...
    try {
      ...
      if (missing.length > 0) {
        const retryUser =
          ...
          (isYandex
            ? "\nДля Яндекс Маркета: описание не короче 600 символов, название 60–80 символов: тип + бренд + модель + 1 прилагательное о товаре (увлажняющий и т.п.), без премиальный/популярный и без объёма."
            : "");
