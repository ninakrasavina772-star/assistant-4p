...
export const PODRUZHKA_COSMETICS_LAYOUT_VERSION = "html-figma-cosmetics-v48-white-scrub";
 ...
 */
export const PODRUZHKA_COSMETICS_FOTO_MODE: PodruzhkaCosmeticsFotoMode = "ai";
