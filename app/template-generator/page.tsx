...
export default function TemplateGeneratorPage() {
  return (
    <AssistantSubpageShell
      ...
      description={
        <>
          Загрузите шаблон Excel → выберите вкладку и контентные столбцы → опишите задание для AI.
          Опционально прикрепите CSV по артикулу SKU. Результат — тот же файл с сохранением
          форматирования.
        </>
      }
    >
